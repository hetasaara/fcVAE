...
train_probs.to_csv("/scratch/cs/csb/projects/single-cell-analysis/FCM/AML_FCM/training_probs_grid2.csv", sep=',',index=False)
df = pandas.DataFrame(data={"rec": val_losses, "acc": accuracies, "disc": disc_losses})
df.to_csv("/scratch/cs/csb/projects/single-cell-analysis/FCM/AML_FCM/validation_metrics2_true.csv", sep=',',index=False)
